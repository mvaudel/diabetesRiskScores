 ...
 * @author Marc Vaudel
 */
public enum BuildScoreOptions {

    input("i", "input", "The score details as text table.", true, true),
    name("n", "name", "The name of the score.", true, true),
    version("v", "version", "The version of the score.", true, true),
    out("o", "out", "File where to write the score definition.", true, true);
     ...
     */
    private BuildScoreOptions(String opt, String longOpt, String description, boolean mandatory, boolean hasArg) {
        this.opt = opt;
    ...
    public static void createOptionsCLI(Options options) {
        ...
        for (BuildScoreOptions option : values()) {
